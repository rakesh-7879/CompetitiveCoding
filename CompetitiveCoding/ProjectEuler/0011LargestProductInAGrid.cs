...
{
    public class _0011LargestProductInAGrid
    {
        public static void Start()
        {
            int[][] grid = new int[20][];
            var inputs = new List<string> { "89 90 95 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08",
            ...
            {
                string[] grid_temp = inputs.Skip(grid_i).FirstOrDefault().Split(' ');
